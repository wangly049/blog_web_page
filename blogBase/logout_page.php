...
<html lang="eng">
    ...
    <body>
            ...
            <div class ="row1" style ="height:600px">
                ...
                <center>
                    <h3 style = "font-family: Times New Roman, Times, serif; font-size: 40px;">See You Next Time</h3>
                    <h3 style = "font-family: Times New Roman, Times, serif; font-size: 40px;">Would you like to return to the <a href="index.php">home</a> page?</h3>
                </center>
            </div>
